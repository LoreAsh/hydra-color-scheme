...
local theme = lush(function(injected_functions)
	...
	return {
		...
		CurSearch      { bg = red.li(35).sa(100), fg = Normal.bg }, -- Highlighting a search pattern under the cursor (see 'hlsearch')
		...
		-- IncSearch      { bg = red }, -- 'incsearch' highlighting; also used for the text replaced with ":s///c"
		...
		Search         { bg = red.li(-20).sa(-30), fg = Normal.bg}, -- Last search pattern highlighting (see 'hlsearch'). Also used for similar items that need to stand out.
		-- SpecialKey     { }, -- Unprintable characters: text displayed differently from what it really is. But not 'listchars' whitespace. |hl-Whitespace|
		-- SpellBad       { }, -- Word that is not recognized by the spellchecker. |spell| Combined with the highlighting used otherwise.
		-- SpellCap       { }, -- Word that should start with a capital. |spell| Combined with the highlighting used otherwise.
		-- SpellLocal     { }, -- Word that is recognized by the spellchecker as one that is used in another region. |spell| Combined with the highlighting used otherwise.
		-- SpellRare      { }, -- Word that is recognized by the spellchecker as one that is hardly ever used. |spell| Combined with the highlighting used otherwise.
		StatusLine     { bg = Normal.fg.li(-10), fg = Normal.bg }, -- Status line of current window
		-- StatusLineNC   { }, -- Status lines of not-current windows. Note: If this is equal to "StatusLine" Vim will use "^^^" in the status line of the current window.
		-- TabLine        { }, -- Tab pages line, not active tab page label
		-- TabLineFill    { }, -- Tab pages line, where there are no labels
		-- TabLineSel     { }, -- Tab pages line, active tab page label
		-- Title          { }, -- Titles for output from ":set all", ":autocmd" etc.
		Visual         { bg = Normal.fg.li(-20), fg = Normal.bg }, -- Visual mode selection
		...
		-- Repeat         { fg = red, bold = true }, --   for, do, while, etc.
		-- Label          { fg = red, bold = true }, --   case, default, etc.
		-- Operator       { fg = red, bold = true }, --   "sizeof", "+", "*", etc.
		-- Keyword        { fg = red, bold = true }, --   any other keyword
		-- Exception      { fg = red, bold = true }, --   try, catch, throw
